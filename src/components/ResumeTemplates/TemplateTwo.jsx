...
const Title = ({ text, color }) => {
  return (
    <div className="relative w-fit mb-2.5">
      ...
      ></span>
      <h2 className={`relative text-sm font-bold tracking-wide text-gray-800`}>{text}</h2>
    </div>
  );
};

const TemplateTwo = ({ resumeData, colorPalette, containerWidth, download }) => {
  ...
  console.log("Download 2: ", download)
            ...
            <div>
              <div className="grid grid-cols-12 gap-2 items-center">
                <div className="col-span-6">
                  ...
                  <p className="text-[15px] font-semibold mb-2 text-black">
