...
const SignUp = ({setCurrentPage}) => {
  ...
  return (
    <div className="w-[90vw] md:w-[33vw] p-7 flex flex-col justify-center bg-gray-900">
      ...
      {!verificationSent ? (
        <form onSubmit={handleSignUp}>
          ...
          <p className="text-[13px] text-slate-400 mt-3">
            Already an account?{" "}
            <button
              className="font-medium text-primary underline text-white hover:text-slate-300 cursor-pointer"
              onClick={() => {
        ...
        <div>
          <div className="bg-slate-200 border border-slate-500 text-slate-800 text-sm p-3 rounded mb-3">
