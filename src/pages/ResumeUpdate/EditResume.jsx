...
const EditResume = () => {
  ...
  const resumePreviewAndDownloadRef = useRef(null);
  const[emailReady, setEmail] = useState(false);
  ...
  <DashboardLayout>
    ...
    <div className="min-h-screen bg-[#0B0F19] text-white">
      <div className="container mx-auto px-4 py-4">
        ...
        <div className="flex items-center justify-between gap-5
                        bg-[#0E1324] rounded-xl border border-white/10
                        py-3 px-4 mb-4">
          <TitleInput
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <span className="hidden md:block !text-white">Change Theme</span>
            </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          {/* ===== Left Form Panel ===== */}
          <div className="bg-[#0E1324] rounded-xl overflow-hidden">
            ...
            <div className="mx-5">
              ...
              <div className="flex items-end justify-end gap-3 mt-4 mb-5">
                <button
                  className="btn-small"
                  onClick={goBack}
                  disabled={isLoading}
          ...
          {/* ===== Right Resume Preview (DO NOT DARKEN) ===== */}
          {/* <div ref={resumeRef} className="h-[100vh] bg-transparent"> */}
            <div ref={resumeRef} className=" bg-transparent">
            <RenderResume
    ...
    <Modal
      ...
      title="Change Theme"
    >
      <div className="w-[90vw] h-[80vh] bg-[#0B0F19]">
        <ThemeSelector
    ...
    >
      {(emailReady || download)?<div ref={resumeDownloadRef} className="w-full h-full bg-white">
        <RenderResume
          templateId={resumeData?.template?.theme || ""}
          resumeData={resumeData}
          colorPalette={resumeData?.template?.colorPalette || []}
          download = {true}
        />
      </div>:<div ref={resumePreviewAndDownloadRef} className="w-full h-full bg-white">
        <RenderResume
          templateId={resumeData?.template?.theme || ""}
          resumeData={resumeData}
          colorPalette={resumeData?.template?.colorPalette || []}
